...
class TaskTimeManager {
 public:
    explicit TaskTimeManager(weibo_task_logic::CrawlerTaskDB* task_db);
 ...
 private:
    weibo_task_logic::TaskSchdulerManager*               schduler_mgr_;
    scoped_ptr<weibo_task_logic::CrawlerTaskDB>          task_db_;
