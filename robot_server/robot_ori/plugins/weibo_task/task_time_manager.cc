...
TaskTimeManager::TaskTimeManager(weibo_task_logic::CrawlerTaskDB* task_db) {
    schduler_mgr_ =  weibo_task_logic::TaskSchdulerEngine::GetTaskSchdulerManager();
...
void TaskTimeManager::TimeFechTempTask() {
	...
	std::list<base_logic::WeiboTask>::iterator task_it = list.begin();
