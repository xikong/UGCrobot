...
class CrawlerTasklogic {
 ...
 private:
    ...
    void InitTask(qzone_task_logic::TaskSchdulerManager* schduler_mgr);
 ...
 private:
    ...
    scoped_ptr<qzone_task_logic::CrawlerTaskDB>             task_db_;
    scoped_ptr<qzone_task_logic::TaskTimeManager>           task_time_mgr_;
