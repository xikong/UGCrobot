...
class CrawlerTaskKafka {
 ...
 public:
    ...
    bool FectchBatchTempTask(std::list<base_logic::WeiboTaskInfo>* list);

    void SetTaskInfo(base_logic::WeiboTaskInfo&task_info, base_logic::DictionaryValue* task_info_dic);
