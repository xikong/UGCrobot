...
typedef std::map<int64, base_logic::WeiboTaskInfo> TASKINFO_MAP;
typedef std::list<base_logic::WeiboTaskInfo>  TASKINFO_LIST;
...
class TaskSchdulerManager {
 public:
    ...
    void FetchBatchTask(std::list<base_logic::WeiboTaskInfo>* list,
            bool is_first = false);

    void FetchBatchTemp(std::list<base_logic::WeiboTaskInfo>* list);
