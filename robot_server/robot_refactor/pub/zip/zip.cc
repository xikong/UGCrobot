...
MZip::MZip(void) :
		zlibStream_(NULL), ulTotalZipLen_(0), bCompress_(true) {
}
...
unsigned long MZip::ZipData(const unsigned char* pUnZipData,
		unsigned long ulUnZipLen, unsigned char** ppZipData) {
