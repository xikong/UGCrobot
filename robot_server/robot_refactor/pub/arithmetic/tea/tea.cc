...
int *key = (int *)"1234567890abcde\0";  // NOLINT //key

// jiami
void encrypt(int *v1, int *v2, int *k, int rounds) {
    int y = *v1, z = *v2, sum = 0, i = 0;
...
// jiemi
void decrypt(int *v1, int *v2, int *k, int rounds) {
    int y = *v1, z = *v2, i = 0, sum;
    if (rounds == 32)
        sum = 0xc6ef3720;
    else
        sum = 0xe3779b90;
