#ifndef VALUE_BINDER_H_Z9GLRFCO
#define VALUE_BINDER_H_Z9GLRFCO

#include <sqlite3.h>

#include "../../../fast/mfast/sqlite3/error.h"
namespace mfast
{
  namespace SQLite3
  {
    ...
    protected:
      ...
      void bind_int(int64_t value)
      {
        core_.bind(info_, current_column_++, value);
      }
    ...
    public:
      ...
      value_binder(const converter_core&     core,
...
#endif /* end of include guard: VALUE_BINDER_H_Z9GLRFCO */
