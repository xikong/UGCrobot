#ifndef THIRD_PASS_VISITOR_H_RLP7YAFO
#define THIRD_PASS_VISITOR_H_RLP7YAFO

#include "../../../fast/mfast/sqlite3/converter_core.h"
...
namespace mfast
{
  namespace SQLite3
  {
    ...
    public:
      third_pass_visitor(const converter_core& core)
        : core_(core)
      {
      }
...
#endif /* end of include guard: THIRD_PASS_VISITOR_H_RLP7YAFO */
