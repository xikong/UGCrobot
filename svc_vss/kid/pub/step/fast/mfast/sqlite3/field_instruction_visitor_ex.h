#ifndef FIELD_INSTRUCTION_VISITOR_EX_H_6MO5UANJ
#define FIELD_INSTRUCTION_VISITOR_EX_H_6MO5UANJ

#include "../../../fast/mfast/field_instructions.h"

namespace mfast
{
  class field_instruction_visitor_ex
...
#endif /* end of include guard: FIELD_INSTRUCTION_VISITOR_EX_H_6MO5UANJ */
