#ifndef SEQUENCE_TYPE_H_YZGXEWR0
#define SEQUENCE_TYPE_H_YZGXEWR0
#include <boost/move/core.hpp>

#include "../../fast/mfast/sequence_ref.h"
namespace mfast
{
  ...
  public:
    ...
    squence_type_base(const cref_type & other,
...
///////////////////////////////////////////////////////
  ...
  template <typename CRef>
  inline
  squence_type_base<CRef>::squence_type_base(mfast::allocator*                                  alloc,
  ...
  template <typename CRef>
  inline
  squence_type_base<CRef>::squence_type_base(std::pair<mfast::allocator*,typename squence_type_base<CRef>::instruction_cptr> p)
    : alloc_(p.first)
  ...
  template <typename CRef>
  inline
  squence_type_base<CRef>::~squence_type_base()
  {
  ...
  template <typename CRef>
  inline
  squence_type_base<CRef>::squence_type_base(const CRef&       other,
                                             mfast::allocator* alloc)
    : alloc_(alloc)
  ...
  template <typename CRef>
  inline const char*
  squence_type_base<CRef>::name() const
  {
  ...
  squence_type_base<CRef>::allocator() const
  {
    return this->alloc_;
  }
...
#endif /* end of include guard: SEQUENCE_TYPE_H_YZGXEWR0 */
