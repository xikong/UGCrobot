#ifndef VIEW_INFO_BUILDER_H_2X2TG0XS
#define VIEW_INFO_BUILDER_H_2X2TG0XS
#include <vector>
#include <map>
#include <deque>

#include "../../../fast/mfast/view_iterator.h"
...
namespace mfast
{
  namespace xml_parser
  {
    ...
    {
    public:
      view_info_builder(mfast::arena_allocator& alloc)
        : alloc_(alloc)
      {
      }
      ...
      aggregate_view_info
      build(const tinyxml2::XMLElement &          element,
...
#endif /* end of include guard: VIEW_INFO_BUILDER_H_2X2TG0XS */
